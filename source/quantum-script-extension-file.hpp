...
#ifndef QUANTUM_SCRIPT_EXTENSION_FILE_HPP
			...
			namespace File {
				...
				class FileContext : public Object {
					...
					public:
						...
						QUANTUM_SCRIPT_EXTENSION_FILE_EXPORT FileContext();
				};

				QUANTUM_SCRIPT_EXTENSION_FILE_EXPORT FileContext *getContext();

				QUANTUM_SCRIPT_EXTENSION_FILE_EXPORT void initExecutive(Executive *executive, void *extensionId);
				QUANTUM_SCRIPT_EXTENSION_FILE_EXPORT void registerInternalExtension(Executive *executive);
