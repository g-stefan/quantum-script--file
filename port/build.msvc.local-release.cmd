...
echo -^> local-release quantum-script-extension-file
...
call :cmdX xyo-cc quantum-script-extension-file --archive-release-sha512 --version-file=source/quantum-script-extension-file.version.ini
